...
values
  ...
  ('member.branch_option_a', 'The set about cycles, hot flashes and monthly changes', 'member', 'The specification names the branch question but not the two option labels. Drawn only from the branch''s own approved questions. Edit freely.'),
  ('member.branch_option_b', 'The set about energy, drive, muscle and recovery', 'member', 'The specification names the branch question but not the two option labels. Drawn only from the branch''s own approved questions. Edit freely.'),
