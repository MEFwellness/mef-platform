...
/**
 * The one piece of reading Your Own Company offers, on its last screen.
 *
 * Same shape as the six Happiness templates beside it and the free arc's
...
import { YOC_COPY, YOC_RESOURCE } from '@/lib/your-own-company/copy';

export function YourOwnCompanyResource() {
  ...
  return (
    <section className="rounded-2xl border border-[#F5F0E4]/15 bg-[#F5F0E4]/[0.06] p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[#F5F0E4]/85">{YOC_RESOURCE.body}</p>
