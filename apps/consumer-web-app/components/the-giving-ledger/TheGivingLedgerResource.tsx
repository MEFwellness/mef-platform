...
/**
 * The one piece of reading The Giving Ledger offers, on its last screen.
 *
 * Same shape as the two Happiness templates beside it and the free arc's
...
import { TGL_COPY, TGL_RESOURCE } from '@/lib/the-giving-ledger/copy';

export function TheGivingLedgerResource() {
  ...
  return (
    <section className="rounded-2xl border border-[#F5F0E4]/15 bg-[#F5F0E4]/[0.06] p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[#F5F0E4]/85">{TGL_RESOURCE.body}</p>
