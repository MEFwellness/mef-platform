...
/**
 * The one piece of reading Being Seen offers, on its last screen.
 *
 * Same shape as the four Happiness templates beside it and the free arc's
...
import { BSN_COPY, BSN_RESOURCE } from '@/lib/being-seen/copy';

export function BeingSeenResource() {
  ...
  return (
    <section className="rounded-2xl border border-[#F5F0E4]/15 bg-[#F5F0E4]/[0.06] p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[#F5F0E4]/85">{BSN_RESOURCE.body}</p>
