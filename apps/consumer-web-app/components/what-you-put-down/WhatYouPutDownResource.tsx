...
/**
 * The one piece of reading What You Put Down offers, on its last screen.
 *
 * Same shape as the five Happiness templates beside it and the free arc's
...
import { WYPD_COPY, WYPD_RESOURCE } from '@/lib/what-you-put-down/copy';

export function WhatYouPutDownResource() {
  ...
  return (
    <section className="rounded-2xl border border-[#F5F0E4]/15 bg-[#F5F0E4]/[0.06] p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[#F5F0E4]/85">{WYPD_RESOURCE.body}</p>
