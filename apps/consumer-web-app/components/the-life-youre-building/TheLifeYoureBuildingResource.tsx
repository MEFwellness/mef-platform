...
/**
 * The one piece of reading The Life You're Building offers, on its last
 * screen.
 *
 * Same shape as the seven Happiness templates beside it and the free arc's
...
import { TLYB_COPY, TLYB_RESOURCE } from '@/lib/the-life-youre-building/copy';

export function TheLifeYoureBuildingResource() {
  ...
  return (
    <section className="rounded-2xl border border-[#F5F0E4]/15 bg-[#F5F0E4]/[0.06] p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[#F5F0E4]/85">{TLYB_RESOURCE.body}</p>
