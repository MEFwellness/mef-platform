 ...
 * read, so a coach retyping the card's invitation in body_systems_copy
...
export async function BodySystemsEntry({ assignmentId }: { assignmentId: string }) {
  ...
  return (
    ...
    >
      ...
      <QuietLink
        href={BODY_SYSTEMS_ROUTE as Route}
