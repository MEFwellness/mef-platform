/**
 * Where Your Joy Lives's persistent card on Home.
 *
 ...
 * lib/where-your-joy-lives/service.ts, so this component has one job and no
 * rules of its own.
 *
 * IT CARRIES THE ASSIGNMENT'S DELIVERY RECEIPT (migration 210), for the
 * reason the two cards beside it carry their own: the pop-up gets one
...
import { WYJL_COPY, WYJL_LABEL } from '@/lib/where-your-joy-lives/copy';
...
export function WhereYourJoyLivesEntry({
  assignmentId,
  hasDraft,
}: {
  assignmentId: string;
  ...
  return (
    ...
    >
      ...
      >
        {hasDraft ? WYJL_COPY.cardResumeCta : WYJL_COPY.cardCta}
