...
export const MEMBER_ONLY_PREFIXES = [
  ...
  '/stress-load',
  // The Rooted Reset Body Systems Survey (coach assigned only). Listed for the same
  // reason: a coach or an administrator who taps an old link belongs on
  // their own dashboard, not inside a member's sitting. Whether she was
  // assigned it is a separate question, enforced inside the route.
  '/body-systems',
  // The Rooted Reset Whole-Body Signal Assessment (coach assigned only). Listed for
  // the same reason: a coach or an administrator who taps an old link
  ...
  // inside the route.
  '/owning-your-value',
  // Where Your Joy Lives (coach assigned only), the second of the Happiness
  // deep-dives. Listed for the same reason: a coach or an administrator who
  // taps an old link belongs on their own dashboard, not inside a member's
  // sitting. Whether she was assigned it is a separate question, enforced
  // inside the route.
  ...
  // inside the route.
  '/the-giving-ledger',
  // The Weight of Yes (coach assigned only), the fourth of the Happiness
  // deep-dives. Listed for the same reason: a coach or an administrator who
  // taps an old link belongs on their own dashboard, not inside a member's
  // sitting. Whether she was assigned it is a separate question, enforced
  // inside the route.
  '/the-weight-of-yes',
  // Being Seen (coach assigned only), the fifth of the Happiness
  // deep-dives. Listed for the same reason: a coach or an administrator who
  // taps an old link belongs on their own dashboard, not inside a member's
  // sitting. Whether she was assigned it is a separate question, enforced
  // inside the route.
  '/being-seen',
  // What You Put Down (coach assigned only), the sixth of the Happiness
  // deep-dives. Listed for the same reason: a coach or an administrator who
  // taps an old link belongs on their own dashboard, not inside a member's
  // sitting. Whether she was assigned it is a separate question, enforced
  // inside the route.
  '/what-you-put-down',
  // Your Own Company (coach assigned only), the seventh of the Happiness
  // deep-dives. Listed for the same reason: a coach or an administrator who
  // taps an old link belongs on their own dashboard, not inside a member's
  // sitting. Whether she was assigned it is a separate question, enforced
  // inside the route.
