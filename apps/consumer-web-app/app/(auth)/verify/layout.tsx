...
/**
 * The verification resend keeps its bot check, so it keeps the preload
 * that gives the check a head start: Cloudflare's script starts
 * downloading while this page is still being parsed rather than after the
 * app hydrates. See components/auth/TurnstilePreload.tsx for the
 * measurement.
 *
