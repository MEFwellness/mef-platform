...
import { NutritionLabelCaptureFlow } from '@/components/food-lens/NutritionLabelCaptureFlow';

export default async function NewFoodLensLabelScanPage() {
