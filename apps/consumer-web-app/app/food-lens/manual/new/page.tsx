...
import { ManualFoodEntryForm } from '@/components/food-products/ManualFoodEntryForm';

export default async function ManualFoodEntryPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#EFF6F1] to-[#FAFAF8] font-[family-name:var(--font-dm-sans)]">
      <main className="mx-auto w-full max-w-md px-5 pb-16 pt-8 sm:px-6 md:max-w-2xl md:px-10 md:pl-28">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-[#6B7A72]">
          Good for homemade meals or anything you already know the details of.
        </p>
